        ...
        {imageSrc && (
          <div className="w-full">
            <img
              ...
              className="w-full h-auto rounded-2xl object-cover pb-2"
            />
          </div>
        )}
        <div
          id="popup-content"
          className="bg-white rounded-2xl p-6 w-full text-center relative transform transition-transform duration-200"
